  ...
  return (
    <div className="container" id="join-section">
      <div className="content">
        ...
        <p className="text">
          Behind every stock image there&apos;s a creative mind.You can also create content and sell
          it on Freepik
        </p>
        <Link to="/register" className="button" target="_blank" rel="noopener noreferrer">
          Sell content
        </Link>
      </div>
      <div className="photo">
