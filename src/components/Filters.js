...
<div>
      <div className='filters'>
        ...
        <button className="btn  btn-light filtersbtn" type="button" id="filters" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling"> 
