			...
			<div className="main-footer">
				...
				<div className="container">
					...
					<div className="sing-in">
						...
						<button type="button" className="btn btn-primary btn-lg singin-btn" >Sing in </button>
					</div>
					{/*Footer-button*/}

					<div className="footer-button">
						<img className="freepik-company" src="https://freepik.cdnpk.net/img/logos/freepikcompany-footer.svg" />
