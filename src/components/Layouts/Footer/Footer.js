              ...
              <div className="row">
                ...
                <div className="col-md-3 col-sm-6">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <Link className="footer-hover" to="/search/the most popular content">
                ...
                <div className="col-md-3 col-sm-6">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <Link className="footer-hover" to="/search/sell your content">
                        Sell your content
                      </Link>
                    </li>
                  </ul>
                ...
                <div className="col-md-3 col-sm-6">
                  ...
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <Link className="footer-hover" to="/search/copyright information">
                        Copyright information
                      </Link>
                    </li>
                    <li>
                      <Link className="footer-hover" to="/search/cookies policy">
                        Cookies policy
                      </Link>
                    </li>
                    <li>
                      <Link className="footer-hover" to="/search/cookies sttings">
                        Cookies settings
                      </Link>
                    </li>
                  </ul>
                ...
                <div className="col-md-3 col-sm-6">
                  ...
                  <div className="sign-upfooter">
                    ...
                    <ul className="signup-footer">
                      <li>
                        <Link className="btn btn-primary footer-hover" to="/signup">
                          Sign up
                        </Link>
                      </li>
                    </ul>
