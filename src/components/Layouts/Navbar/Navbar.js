            ...
            <div className="container-fluid">
              ...
              <div className={`side-menu collapse ${sideVisibility}`} id="sideMenu">
                <div className="side-menu-header" onClick={toggleSide}>
                  <i>
                    <img src={'/assets/images/common/navbar/close-icon.png'} alt="close" />
                  </i>
                </div>
                  ...
                  <ul className="side-menu-list">
                    <li>
                      <div className="anchor-rep">
                        <Link onClick={toggleSide} className="anchor-rep" to="/search/vectors">
                          Vectors
                        </Link>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="anchor-rep">
                        <Link onClick={toggleSide} className="anchor-rep" to="/search/popular-psd">
                          PSD
                        </Link>
                      </div>
                    </li>
                    <li>
                      <div className="anchor-rep">
                        <Link onClick={toggleSide} className="anchor-rep" to="/3d-models">
                          3D
                        </Link>
                      </div>
                    ...
                    <li>
                      <div className="anchor-rep">
                        <Link onClick={toggleSide} className="anchor-rep" to="/fonts">
                          Fonts
                        </Link>
                      </div>
                    </li>
                    ...
                    {catVisibility ? (
                      <div className={'side-drop-list-cat' + shadowStyle}>
                        {Categories.map((category, index) => {
                          return (
                            <li key={index}>
                              <Link className="anchor-rep" to={category.url} onClick={toggleSide}>
                                {category.name}
                              </Link>
                            </li>
                          )
                    ...
                    <li>
                      <div className="anchor-rep">
                        <Link onClick={toggleSide} className="anchor-rep" to="/collections">
                          Collections
                        </Link>
                      </div>
                    </li>
                          ...
                          return (
                            <ul key={index}>
                              ...
                              <div className="more-items">
                                {item[Object.keys(item)].map((innerItem, inneridx) => {
                                  return (
                          ...
                          <>
                            {item.link !== null ? (
                              <li key={index}>
                                ...
                                {item.new ? <button className="btn btn-new">NEW</button> : null}
                              </li>
                            ) : (
                              <>
                                {item.name === 'More' ? (
                                  <>
                                    <li onClick={toggleMoreDropdown} key={index}>
                                      ...
                                      {moreVisibility ? (
                                        <div className={'more-drop-list' + shadowStyle}>
                                          {MoreContent.map((item, index) => {
                                            return (
                                              <ul key={index}>
                                                <h4>{Object.keys(item)[0].toUpperCase()}</h4>
                                  ...
                                  <>
                                    <li onClick={toggleCatDropdown} key={index}>
                                      ...
                                      {catVisibility ? (
                                        <div className={'cat-drop-list' + shadowStyle}>
                                          {Categories.map((category, index) => {
                                            return (
                                              <li key={index}>
