export const SideBarData1=[
    {
       tag:1,
        ...
        id:'categoryCollapse',target:"#categoryCollapse",page:'search'
    ...
    id:"licenseCollapse",page:'search'
    ...
    id:"colorsCollapse",page:'search'
      
},{
    collapse:'People', icon:"bi bi-person-video",
    tag:1,
    tags:['With People','No people'],
    icon1:['bi bi-person-video ','bx bx-rectangle '],sub:1,
...
{title:'Ethnicity',tags:['South Asian','Middle Eastern','Black','East Asian','Hispanic','Indian','White'],id:'ethnicityCollapse'}],
    id:"peopleCollapse",page:'search',
        info:'yes'
}, {
    collapse:'File Type', icon:'bx bx-file',
    tag:1,
    tags:[
        'PSD','AI','EPS'
    ],icon1:[''],
    id:"licenseCollapsed",
        aria:"licenseCollapse",page:'search'
},
    {
    ...
    ],icon1:['bx bx-rectangle','bx bx-rectangle bx-rotate-90 ','bx bx-rectangle bx-rotate-90 ','bx bx-rectangle'],
    id:"orientationCollapse",page:'search'
},{
    collapse:'Quick edit',icon:'bi bi-brush',par:'Edit online with Wepik or Storyset',toggle:1,id:'editCollapse',switchId:'editToggle',links:[
    ...
    collapse:'Puplish Date',icon:'bx bxs-calendar',icon1:[],tags:['Last 3 months','Last 6 months','Last year'],id:'puplishDateCollapse',tag:1,page:'search'
},{    collapse:"Freepik's choice",
icon:"bx bxs-star",toggle:1,id:'choiceCollapse',par:'See our favorites',switchId:'choiceToggle',page:'search'}
]
