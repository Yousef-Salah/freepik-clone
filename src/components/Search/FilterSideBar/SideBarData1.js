...
{title:'Ethnicity',tags:['South Asian','Middle Eastern','Black','East Asian','Hispanic','Indian','White'],id:'ethnicityCollapse'}],
    ...
    collapse:'Puplish Date',icon:'bx bxs-calendar',icon1:[],tags:['Last 3 months','Last 6 months','Last year'],id:'puplishDateCollapse',tag:1
},{    collapse:"Freepik's choice",
icon:"bx bxs-star",toggle:1,id:'choiceCollapse',par:'See our favorites',switchId:'choiceToggle'}
]
