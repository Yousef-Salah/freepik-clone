...
const PricingSection = () => (
  <div className="tab-content" id="pills-tabContent">
    <div
      className="tab-pane fade show active pricing-photo-wrapper"
      id="pills-individual"
      role="tabpanel"
      aria-labelledby="pills-individual-tab"
    >
      <img
        src="/assets/images/account_premium/pricing-page/pricing1.png"
        alt="pricing-photo1"
        className="pricing-photo1"
      />
            ...
            <table className="table table-borderless">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <i className="fa-sharp fa-solid fa-check tick" />
                  </td>
                  <td>
                    <i className="fa-sharp fa-solid fa-check tick" />
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <i className="fa-solid fa-x fales" />
                  </td>
                  <td>
                    <i className="fa-sharp fa-solid fa-check tick" />
                  </td>
        ...
        <div className="card-section">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                <span className="color-textcard">
                  months
                  <br />* VAT and local taxes may apply
                </span>
              </p>
              <Link href="/login" className="btn btn-primary btn-subs">
                Subscribe now
              </Link>
            </div>
          </div>
          ...
          <div className="card card3">
            <div className="card-body">
              ...
              <Link to="/login" className="btn btn-primary btn-subs">
                Subscribe now
              </Link>
            </div>
          </div>
    ...
    <div
      className="tab-pane fade pricing-photo-wrapper"
      id="pills-teams"
      role="tabpanel"
      aria-labelledby="pills-teams-tab"
    >
      <img
        src="/assets/images/account_premium/pricing-page/pricing2.png"
        alt="pricing-photo2"
        className="pricing-photo1"
      />
      <div className="card-section2">
        <div className="card card-teams1">
          <div className="card-body">
            ...
            <p className="card-text">
              Created for all those teams who want access to unlimited creative
              assets. Designed to facilitate collaborative work and an
              inexhaustible source of inspiration with the easiest management
              structure.
            </p>
            <div className="card-information">
              <p className="card-text">
                <i className="fa-sharp fa-solid fa-check tick" />
                All the benefits of a Premium plan
              </p>

              <p className="card-text">
                {/* eslint-disable-next-line */}
                <i className="fa-sharp fa-solid fa-check tick" />A single
              ...
              <p className="card-text">
                <i className="fa-sharp fa-solid fa-check tick" />
                The greater number of seats, the greater the discount
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="card-bd">
              ...
              <div className="tab-content" id="pills-tabContent">
                ...
                >
                  ...
                  <br /> 483.84 EUR every 12 months. VAT and local taxes may
                  apply
                </div>
                <div
                ...
                >
                  <strong className="font-eur">13.44 EUR</strong> per seat/month{' '}
                  67.20 EUR every month. VAT and local taxes may apply.
                </div>
              </div>
            </div>
