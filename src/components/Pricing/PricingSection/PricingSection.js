...
const PricingSection = () => {
  return (
    <div className="tab-content" id="pills-tabContent">
      ...
      >
        <img src="/assets/images/pricing-page/pricing1.png" alt="pricing-photo1" />
              ...
              <table className="table table-borderless">
                <thead>
                  <tr>
                    ...
                    <th>Free</th>
                    <th>
                      <i className="fa-sharp fa-solid fa-crown logo-crown">Premium</i>
                    </th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="card card2">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  <span className="color-textcard">every</span> <strong>12</strong>{' '}
            ...
            <div className="card card3">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  <span className="color-textcard">/month</span> <strong>15 EUR*</strong>{' '}
                  <span className="color-textcard">
                    {' '}
      ...
      >
        <img src="/assets/images/pricing-page/pricing2.png" alt="pricing-photo2" />
        <div className="card-section2 row row-col-lg-2 row-col-1 row-col-sm-1 row-col-md-2">
          <div className="card card-teams1">
            <div className="card-body">
              ...
              <p className="card-text">
                Created for all those teams who want access to unlimited creative assets. Designed
                to facilitate collaborative work and an inexhaustible source of inspiration with the
                easiest management structure.
              </p>
              <div className="card-information">
                <p className="card-text">
                  <i className="fa-sharp fa-solid fa-check tick"></i> All the benefits of a Premium
                  plan
                </p>

                <p className="card-text">
                  <i className="fa-sharp fa-solid fa-check tick"></i>A single administrator account
                  to manage everything from it
                </p>

                <p className="card-text">
                  <i className="fa-sharp fa-solid fa-check tick"></i> Personalized plan according to
                  your needs
                </p>

                <p className="card-text">
                  <i className="fa-sharp fa-solid fa-check tick"></i> Technical and legal advice
                </p>

                <p className="card-text">
                  <i className="fa-sharp fa-solid fa-check tick"></i> The greater number of seats,
            ...
            <div className="card-body">
              ...
              <div className="card-bd">
                ...
                <div className="tab-content" id="pills-tabContent">
                  ...
                  >
                    <strong className="font-eur">8.06 EUR</strong> per seat/month
                  ...
                  >
                    <strong className="font-eur">13.44 EUR </strong>per seat/month 67.20 EUR every
                    month. VAT and local taxes may apply.
                  </div>
                </div>
              </div>
