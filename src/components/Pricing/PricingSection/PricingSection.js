...
const PricingSection = () => {
  return (
    <div className="tab-content" id="pills-tabContent">
      <div className="tab-pane fade show active " id="pills-individual" role="tabpanel" aria-labelledby="pills-individual-tab"><img src='/assets/images/pricing-page/pricing1.png' alt='pricing-photo1' />
              ...
              <table className="table table-borderless">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <strong>
                        +8,787,000 vector icons, stickers, and logos <span className='new-sp'>New</span>
                      </strong>
                    </td>
                    <td>
                      <i className="fa-solid fa-x fales"></i>
                  ...
                  <tr>
                    <td>
                      Unlimited downloads <span className="more-info">more info</span>
                    </td>
                    <td>
                      <i className="fa-solid fa-x fales"></i>
                    </td>
          ...
          <div className='card-section'>
            <div className="card card2">
              <div className="card-body">
                ...
                <h5 className="card-title"><strong className='font-strong'>12 MONTHS</strong></h5>
      ...
      <div className="tab-pane fade" id="pills-teams" role="tabpanel" aria-labelledby="pills-teams-tab"><img src='/assets/images/pricing-page/pricing2.png' alt='pricing-photo2' />
        <div className='card-section2 row row-col-lg-2 row-col-1 row-col-sm-1 row-col-md-2'>
          <div className="card card-teams1">
            <div className="card-body">
              ...
              <p className="card-text">Created for all those teams who want access to unlimited creative assets. Designed to facilitate collaborative work and an inexhaustible source of inspiration with the easiest management structure.</p>
              <div className='card-information'>

                <p className="card-text"><i className="fa-sharp fa-solid fa-check tick"></i> All the benefits of a Premium plan</p>

                <p className="card-text"><i className="fa-sharp fa-solid fa-check tick"></i>A single administrator account to manage everything from it</p>

                <p className="card-text"><i className="fa-sharp fa-solid fa-check tick"></i> Personalized plan according to your needs</p>

                <p className="card-text"><i className="fa-sharp fa-solid fa-check tick"></i> Technical and legal advice</p>

                <p className="card-text"><i className="fa-sharp fa-solid fa-check tick"></i> The greater number of seats, the greater the discount</p>
              </div>
          ...
          <div className="card card-temas2">
            <div className="card-body">
              <h3 className="card-title"><strong>Customize your Teams plan</strong></h3>
              <div className='card-tite'>
                <div className="card-text2"> Billing frequency</div>
                <div className='card-text3'>Number of seats </div>
              </div>
              <div className='input-value'>
                <input type="text" className="form-control" placeholder="5" aria-label="5" ></input>
              </div>
              <div className='card-bd'>
                ...
                <div className="tab-content" id="pills-tabContent">
                  <div className="tab-pane fade show active" id="pills-annual" role="tabpanel" aria-labelledby="pills-annual-tab"><strong className='font-eur'>8.06 EUR</strong> per seat/month
                    <br></br>    483.84 EUR every 12 months. VAT and local taxes may apply
                  </div>
                  <div className="tab-pane fade" id="pills-monthly" role="tabpanel" aria-labelledby="pills-monthly-tab"><strong className='font-eur'>13.44 EUR </strong>per seat/month
                    67.20 EUR every month. VAT and local taxes may apply.</div>
                </div>
              </div>
