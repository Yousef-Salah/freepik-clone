          ...
          <div className="enhance">
            ...
            <div className="card-body">
              ...
              <p className="card-text" id="symbolText">
                ...
                attributing the author. High-quality photos, fonts, vector
                icons, stickers, and logos ready to use.
              </p>
            </div>
          </div>
        </div>
        <div className="col">
          <div className="enhance">
            ...
            <div className="card-body">
              ...
              <p className="card-text" id="symbolText">
                Access to Freepik and Flaticon Premium content. Download
                exclusive editable images and more than 7.7MM vector icons,
                stickers, and logos.
              </p>
            </div>
          </div>
