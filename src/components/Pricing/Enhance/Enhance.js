      ...
      <div className="row row-cols-1 row-cols-md-4 " id="Enhance-container">
        <div className="col">
          <div className="enhance">
            <img src={file} className="card-img-top" id="Enhance-img" alt="file"></img>
        ...
        <div className="col">
          <div className="enhance">
            <img src={crown} className="card-img-top" id="Enhance-img" alt="crown"></img>
            <div className="card-body">
        ...
        <div className="col">
          <div className="enhance">
            <img src={refresh} className="card-img-top" id="Enhance-img" alt="refresh"></img>
            <div className="card-body">
        ...
        <div className="col">
          <div className="enhance">
            <img src={add} className="card-img-top" id="Enhance-img" alt="add"></img>
            <div className="card-body">
