    ...
    <div className="mt-5" id="sponsored-by-component">
      <div className="container rounded p-5">
        ...
        <section className="row" id="sponsor-details">
          ...
          <span id="ten-free">
            <a className="text-decoration-none" href="https://stock.adobe.com/promo/firstmonthfree?clickref=1011lwihvE5p&mv=affiliate&mv2=Freepik&as_camptype=&as_channel=affiliate&as_source=partnerize&as_campaign=Freepik&as_content=api&as_audience=srp&sdid=6WTV6YJ5">
              Get 10 free Vevtors
            </a>
          </span>
