...
function shuffle() {
  ...
  function clear() {
    document.getElementById("btn1").classList.remove("size-selected");
    document.getElementById("btn2").classList.remove("size-selected");
    document.getElementById("btn3").classList.remove("size-selected");
    document.getElementById("btn4").classList.remove("size-selected");
  ...
  function button2Click() {
    clear();
    document.getElementById("btn2").classList.add("size-selected");
    for (let i = 0; i < title.length; i++) {
  ...
  function button3Click() {
    clear();
    document.getElementById("btn3").classList.add("size-selected");
    for (let i = 0; i < title.length; i++) {
  ...
  function button4Click() {
    clear();
    document.getElementById("btn4").classList.add("size-selected");
    for (let i = 0; i < title.length; i++) {
