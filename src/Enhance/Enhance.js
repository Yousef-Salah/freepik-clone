...
const Enhance = () => {
    return (
      ...
      <div className='EnhanceCard'>
        <img src={file} className="Enhance-img"></img>
        <h5 className='EnhanceTitle'>Full license</h5>
        <p className='EnhanceText'>You can use any asset for commercial or personal use without attributing the author. High-quality photos, fonts, vector icons, stickers, and logos ready to use.</p>
        </div>
